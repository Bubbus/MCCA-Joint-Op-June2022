...
SET_SQUAD_IMPORTANT(C-1,true);
SET_SQUAD_COLOUR(C-1,COLOUR_GREEN);

SET_SQUAD_IMPORTANT(C-2,true);
SET_SQUAD_COLOUR(C-2,COLOUR_GREEN);

SET_SQUAD_IMPORTANT(C-3,true);
SET_SQUAD_COLOUR(C-3,COLOUR_GREEN);


SET_SQUAD_IMPORTANT(SUNRAY,true);
SET_SQUAD_COLOUR(SUNRAY,COLOUR_YELLOW);
SET_SQUAD_ICON(SUNRAY,ICON_HQ);


SET_SQUAD_IMPORTANT(MMG,true);
SET_SQUAD_COLOUR(MMG,COLOUR_ORANGE);
SET_SQUAD_ICON(MMG,ICON_HEAVYWEAPONS);


SET_SQUAD_IMPORTANT(SNIPER,true);
SET_SQUAD_COLOUR(SNIPER,COLOUR_ORANGE);
SET_SQUAD_ICON(SNIPER,ICON_RECON);